              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to deprovision this device?
                  </p>
                  <div className="mt-3 p-3 bg-gray-50 rounded">
                    ...
                    <p className="text-sm text-gray-600">Bunker: {device.bunker_name}</p>
                    <p className="text-sm text-gray-600">Fan Position: {device.fan_position}</p>
                  </div>
                  <p className="mt-3 text-sm text-red-600 font-medium">
                    This action cannot be undone. The device will need to be re-provisioned.
                  </p>
                </div>
              </div>
            </div>
